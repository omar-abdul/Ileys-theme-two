...
function customTheme_script_enqueue(){
    ...
    wp_enqueue_style('customstyle', get_template_directory_uri()."/css/ileys.min.css", array(), "1.0.1", "all" );
...
function searchfilter($query) {
    ...
    if ($query->is_search && !is_admin() ) {
        $query->set('post_type',array('trading','brands'));
    }
...
function query_post_type($query) {
  if( is_category() ) {
    ...
    $post_type = array('nav_menu_item','trading','brands'); // don't forget nav_menu_item to allow menus to work!
